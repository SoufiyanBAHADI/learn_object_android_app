...
public class Legume extends Sprite {
    private int id;
    private AndroidSound mAndroidSound;
    private AndroidSound qAndroidSound;
    public Legume(Game game, int id, Image image, AndroidSound sound,AndroidSound question , int x, int y, int height, int width) {
