...
public class Vetement extends Sprite {
    private int id;
    private AndroidSound mAndroidSound;
    private AndroidSound qAndroidSound;

    public Vetement(Game game, int id, Image image, AndroidSound sound, AndroidSound question , int x, int y, int height, int width) {
